...
class UpdateTaskUseCase implements UseCaseOneInput<UpdateTaskModel, dynamic> {
  @override
  Future<Either<Failure, dynamic>> invoke(UpdateTaskModel body) async {
    return await serviceLocator
        .get<UpdateTaskRepository>()
